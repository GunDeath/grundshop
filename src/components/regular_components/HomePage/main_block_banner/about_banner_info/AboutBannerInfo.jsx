        ...
        <>
            {banner.map(element =>
                <div className={classes.about_banner_info_block} key={element.id}>
                    <div>
                        <p className={classes.title_about_banner_info}>Преимущества нашего магазина</p>
                    </div>
                    <div>
                        <h3 className={classes.about_banner_info_elem_title}>{element.title}</h3>
                        <div className={classes.about_banner_info_elem_text}>{element.body}</div>
                    </div>
                    <div className={classes.about_banner_button_block}>
                        <div
                            className={classes.about_banner_button}
                            onClick={()=>{buttonClickPrev()}}
                        >
                            <PrevArrow />
                        </div>
                        <div
